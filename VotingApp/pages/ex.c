...
void frontscreen(void)
{
	...
	glClearColor(0.0, 0.0, 0.05, 0);/*background for cover page*/
	glClear(GL_COLOR_BUFFER_BIT);
	glColor3f(1, 0, 0);
	drawstring(450.0, 700.0, 0.0, "BRINDAVAN COLLEGE OF ENGINEERING ");
	glColor3f(0.7, 0, 1);
	...
	glColor3f(1, 1, 1);
	drawstring(100, 240, 0.0, "AISHWARYA JANGAM");
	glColor3f(1, 0.5, 0);
	drawstring(980, 400, 0.0, "GUIDE:  MRS.SHYLAJA");
	glColor3f(1, 1, 1);
	drawstring(930, 300, 0.0, "NAME:");
	glColor3f(1, 1, 1);
	drawstring(930, 240, 0.0, "DEEPAK C.R");
	glColor3f(1, 0.1, 1);
